...
public class UserDataServiceImpl implements UserDataService {
  ...
  public Mono<User> getUserByIdentifier(String identifier) {
    return logicService.getUserByIdentifier(identifier, false);
  }
   ...
   */
  @Override
  public Mono<User> getUserByIdentifier(String identifier, boolean getStrapiId) {
    return logicService.getUserByIdentifier(identifier, getStrapiId);
  }
  ...
  public Mono<User> getUserByEmail(String email) {
    return logicService.getUserByEmail(email, false);
  }
   ...
   */
  @Override
  public Mono<User> getUserByEmail(String email, boolean getStrapiId) {
    return logicService.getUserByEmail(email, getStrapiId);
  }
  ...
  public Mono<User> getUserByTokenReset(String tokenReset) {
    return logicService.getUserByTokenReset(tokenReset);
  }
  ...
  public Mono<OAuthTokenResponse> login(
    ...
    return logicService.login(username, email, password, clientCredential, request);
  }
  ...
  public Mono<User> getUserInfo(JWTData jwtData, String token) {
    return logicService.getUserInfo(jwtData, token);
  }
  ...
  public Mono<User> registerUser(
    ...
    return logicService.registerUser(bearer, user, clientCredential, assignNewClient);
  }
  ...
  public Mono<User> updateUser(User userToUpdate) {
    return logicService.updateUser(userToUpdate, false, true);
  }
  ...
  public Mono<User> updateUser(User userToUpdate, boolean isUpdatePassword) {
    return logicService.updateUser(userToUpdate, isUpdatePassword, true);
  }
   ...
   */
  @Override
  public Mono<User> updateUser(boolean callStrapiUserByIdentifier, User userToUpdate) {
    return logicService.updateUser(userToUpdate, false, callStrapiUserByIdentifier);
  }
   ...
   */
  @Override
  public Mono<User> updateUserProcess(
      User userToUpdate, boolean isUpdatePassword, boolean callStrapiUserByIdentifier) {
    return logicService.updateUser(userToUpdate, isUpdatePassword, callStrapiUserByIdentifier);
  }
  ...
  public Mono<OAuthTokenResponse> refreshJWTToken(
      ...
      String token,
      ServerHttpRequest request) {
    return logicService.refreshJWTToken(accessTokenData, clientCredential, token, request);
  }
  ...
  public Mono<Void> logout(String refresh_token, AccessTokenData accessTokenData) {
    return logicService.logout(refresh_token, accessTokenData);
  }
  ...
  public Mono<List<User>> getStrapiUsers(String strapi_bearer) {
    return logicService.getStrapiUsers(strapi_bearer);
  }
   ...
   */
  @Override
  public Mono<List<User>> getUsersFromDatabase() {
    return logicService.getUsers();
  }
  ...
  public void saveUserIntoDatabase(User user) {
    logicService.saveUserIntoDatabase(user);
  }
  ...
  public void updateUserIntoDatabase(User user) {
    logicService.updateUserIntoDatabase(user);
  }
  ...
  public void deleteUserFromDatabase(User user) {
    logicService.deleteUserFromDatabase(user);
  }
}
