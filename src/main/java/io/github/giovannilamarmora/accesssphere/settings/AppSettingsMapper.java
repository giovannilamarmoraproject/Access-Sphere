...
public class AppSettingsMapper {
  ...
  public static void updateEntity(AppSettingsEntity target, AppSettingsDTO source) {
    ...
    if (source.getLoginSettings() != null) {
      ...
      if (map.containsKey("loginMode") && source.getLoginMode() == null && map.get("loginMode") != null)
        target.setLoginMode(map.get("loginMode").toString());
      if (map.containsKey("loginBgUrl") && source.getLoginBgUrl() == null && map.get("loginBgUrl") != null)
        target.setLoginBgUrl(map.get("loginBgUrl").toString());
      if (map.containsKey("loginBgOpacity") && source.getLoginBgOpacity() == null && map.get("loginBgOpacity") != null) {
        if (map.get("loginBgOpacity") instanceof Number num) target.setLoginBgOpacity(num.intValue());
      }
      if (map.containsKey("loginHeroTitle") && source.getLoginHeroTitle() == null && map.get("loginHeroTitle") != null)
        target.setLoginHeroTitle(map.get("loginHeroTitle").toString());
      if (map.containsKey("loginHeroSubtitle") && source.getLoginHeroSubtitle() == null && map.get("loginHeroSubtitle") != null)
        target.setLoginHeroSubtitle(map.get("loginHeroSubtitle").toString());
      if (map.containsKey("hideHomeButton") && source.getHideHomeButton() == null && map.get("hideHomeButton") != null) {
    ...
    if (source.getBrandingSettings() != null) {
      ...
      if (map.containsKey("appTagline") && source.getAppTagline() == null && map.get("appTagline") != null)
        target.setAppTagline(map.get("appTagline").toString());
      if (map.containsKey("logoUrl") && source.getLogoUrl() == null && map.get("logoUrl") != null)
        target.setLogoUrl(map.get("logoUrl").toString());
      if (map.containsKey("faviconUrl") && source.getFaviconUrl() == null && map.get("faviconUrl") != null)
        target.setFaviconUrl(map.get("faviconUrl").toString());
      if (map.containsKey("footerCopyright") && source.getFooterCopyright() == null && map.get("footerCopyright") != null)
        target.setFooterCopyright(map.get("footerCopyright").toString());
      if (map.containsKey("supportEmail") && source.getSupportEmail() == null && map.get("supportEmail") != null)
    ...
    if (source.getPolicySettings() != null) {
      ...
      if (map.containsKey("privacyPolicyUrl") && source.getPrivacyPolicyUrl() == null && map.get("privacyPolicyUrl") != null)
        target.setPrivacyPolicyUrl(map.get("privacyPolicyUrl").toString());
      if (map.containsKey("cookiePolicyUrl") && source.getCookiePolicyUrl() == null && map.get("cookiePolicyUrl") != null)
